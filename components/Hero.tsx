...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      dark:bg-grid-white/[0.03] bg-grid-black/[0.2]  absolute 
      ...
      <div className="flex justify-center relative my-20 z-10">
        ...
        ">
          ...
          ">Dynmic web Magic with Next.js </h2>
          <TextGenerateEffect 
          className="text-center text-[40px] md:text-5xl lg:text-6xl"
          words="Transform Consept into Seamless User Experiences"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm 
          md:text-lg lg:text-2xl">
            Hi I&rsquo;m Mahmoud a Next.js Developer based in Egypt
          </p>
        <a href="#about">
